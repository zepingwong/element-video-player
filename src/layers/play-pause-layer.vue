<template>
  <div class="vcp-layer play-pause-layer" @click="onClick">
    <a v-if="!isPlaying" v-show="show" href="javascript:" :class="['btn-control', {'mobile': isMobile}]" @click="play">
    ...
    <a v-if="isPlaying" v-show="show" href="javascript:" :class="['btn-control', {'mobile': isMobile}]" @click="pause">
