<template>
  <div class="vue-core-video-player-control volume-control">
    ...
    <div class="btn-control-panel">
      <div ref="progress" class="progress" @click="seek">
...
export default {
  ...
  created() {
    ...
    this.volume = this.muted ? 0 : parseInt(DEFAULT_CONFIG.volume * 100, 16)
  },
  ...
  methods: {
    ...
    setRangeValue(value) {
      this.volume = parseInt(value * 100, 16)
    },
    ...
    toggle() {
      ...
      if (this.isMuted) {
        ...
        this.$player.setMuted(false)
        this.volume = parseInt(this.$player.getVolume() * 100, 16)
      }
    }
