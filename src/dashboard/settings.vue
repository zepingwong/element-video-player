      ...
      <ul v-show="currentPanel" class="current-panel">
        <li>
          <span class="item-name">
            {{i18n.t('dashboard.settings.autoplay')}}
          </span>
        ...
        <li>
          <span class="item-name" >{{i18n.t('dashboard.settings.loop')}}</span>
          <div class="item-control">
            <widgets-switch ref="loopSwitch" @change="changeLoopSettings"></widgets-switch>
          </div>
        </li>
        <li>
          <span class="item-name">{{i18n.t('dashboard.settings.speed')}}</span>
        ...
        <li v-show="medias.length > 1">
          <span class="item-name">{{i18n.t('dashboard.settings.resolution')}}</span>
